module.exports = grammar({
  ...
  rules: {
    ...
    keyword_simliar: _ => make_keyword("similar"),

    _similar_to: $ => seq($.keyword_simliar, $.keyword_to),
    _not_similar_to: $ => seq($.keyword_not, $.keyword_simliar, $.keyword_to),
    ...
    predicate: $ => choice(
      ...[
        ...
        [seq($.keyword_simliar, $.keyword_to), 'pattern_matching'],
        [seq($.keyword_not,$.keyword_simliar, $.keyword_to), 'pattern_matching'],
